...
from flask import request, redirect, render_template, url_for, send_file, current_app, send_from_directory, Flask
...
def anchor_upload():
    if request.method == 'POST' and 'file' in request.files:
        ...
        UPLOAD_FOLDER = os.path.join(os.path.abspath("app"), "static", 'Course_Material', upsem, upsub, material)
